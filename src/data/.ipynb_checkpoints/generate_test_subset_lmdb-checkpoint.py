...
OUT_DB_PATH   = pathlib.Path("/global/homes/p/peterwg/pscratch/aujasvit/multires-ct/dataset/C4KS/lmdb_test_subset/test_100.lmdb")  # file or directory path (see SUBDIR)
SUBDIR        = False          # False => single-file .lmdb ; True => directory LMDB
FORCE         = True           # delete OUT_DB_PATH if it exists
NUM_SAMPLES   = 100           # how many samples to keep (prefix of shuffled order)
